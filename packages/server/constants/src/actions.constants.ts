...
export const Action = toMap([
  ...
  'DELIVER',
  'FAIL',
  // Staff/admin RBAC seed matrix actions (doc 06 §3): catalog:write,
  // refund:request/approve, access:write/revoke.
  'WRITE',
  'REQUEST',
  'APPROVE',
  'REVOKE',
  // Indicators task queue verbs (docs/indicators/design): claiming an ops
  // task and confirming its execution don't map onto any existing verb.
  'CLAIM',
  'CONFIRM',
] as const);
