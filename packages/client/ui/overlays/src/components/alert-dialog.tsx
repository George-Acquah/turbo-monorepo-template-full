...
function AlertDialogCancel({
  className,
  ...props
}: React.ComponentProps<typeof Button> & DialogPrimitive.Close.Props) {
  const { render: _, ...buttonProps } = props;
  return (
    <DialogPrimitive.Close
      render={<Button variant="outline" className={className} {...buttonProps} />}
    />
  );
}
