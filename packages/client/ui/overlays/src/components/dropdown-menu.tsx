...
function DropdownMenuShortcut({
  ...
  return (
    <kbd
      ...
      className={cn(
        "ml-auto rounded border border-glass-border px-1.5 py-0.5 font-mono text-[10px] tracking-widest text-muted-foreground group-focus/dropdown-menu-item:text-accent-foreground",
        className
      )}
      {...props}
    />
